...
# cheetah_run walker_run quadruped_run quadruped_walk finger_turn_hard acrobot_swingup reacher_hard reach_duplo
...
do
  ...
  echo "#SBATCH --job-name=MSAC_${task}_${seed}" >> temprun.sh
  ...
  echo "#SBATCH -o /home/*/MICo_SA_C/results/${task}_${seed}.log" >> temprun.sh
  echo "module load miniconda/3" >> temprun.sh
  echo "conda activate simsr" >> temprun.sh
